      ...
      <div style={{ maxWidth: 1400, width: '100%', margin: '0 auto' }}>
        ...
        {displayData && (() => {
          ...
          const navBtn = (r: string, label: string) => (
            <button
              onClick={() => { setQuery(r); handleLookup(r); }}
              ...
              {isComplete && (
                <>
                  ...
                  <p style={{ margin: '14px 0 0', fontSize: 11, color: 'rgba(200,180,150,.4)', lineHeight: 1.5 }}>
                    ...
                    {' '}Masoretic Text: Westminster Leningrad Codex via Sefaria · Septuagint: Rahlfs edition via GetBible ·
                    Vulgate: Clementine edition via GetBible · Dead Sea Scrolls: AI-searched from published academic sources ·
